        ...
        <>
            ...
            <PopIn isOpen={isOpen} setIsOpen={setIsOpen}>
                <div style={{ padding: "40px" }}>
                    ...
                    <p>
                        A snap is a program that runs in an isolated environment that can extend the functionality of MetaMask. In this
                        case, Starknet uses Snaps to add support for—and create an account on—Starknet using MetaMask.
                    </p>
