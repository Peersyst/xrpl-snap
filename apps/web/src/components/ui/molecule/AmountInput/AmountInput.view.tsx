...
export const AmountInputView = ({ disabled, error, helperText, label, decimalsMax = 18, asset, onChangeCustom, ...otherProps }: Props) => {
    ...
    const handleOnKeyDown = (event: KeyboardEvent<HTMLInputElement>) => {
        ...
        if (
            (!/[0-9]|\./.test(event.key) || (event.key === "." && inputRef.current && inputRef.current.value.includes("."))) &&
