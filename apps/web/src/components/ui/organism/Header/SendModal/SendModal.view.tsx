...
import { Buttons, ButtonStyled, Header, MessageAlert, Network, Separator, SeparatorSmall, Title, Wrapper } from "./SendModal.style";
...
export const SendModalView = ({ closeModal }: Props) => {
    ...
    return (
        <>
            ...
            {summaryModalOpen && (
                <SendSummaryModal closeModal={closeModal} address={fields.address} amount={fields.amount} chainId={fields.chainId} />
            )}
        </>
    );
};
