import { ConnectButton, DescriptionCentered, MetamaskIcon, StarknetLogo, Title, Wrapper } from "./NoMetamaskModal.style";
    ...
    return (
        <Wrapper>
            ...
            <a href="https://metamask.io/" target="_blank" rel="noreferrer noopener">
                <ConnectButton customIconLeft={<MetamaskIcon />} onClick={() => undefined}>
                    Download MetaMask
                </ConnectButton>
            </a>
        </Wrapper>
