...
export type HandlerParams<Method extends HandlerMethod> = Parameters<
  ReturnType<typeof HandlerFactory>[Method]['handle']
>[1];

export type HandlerReturns<Method extends HandlerMethod> = ReturnType<
  ReturnType<typeof HandlerFactory>[Method]['handle']
>;
