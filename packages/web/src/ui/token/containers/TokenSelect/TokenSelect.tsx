import { Row, SelectOption, SelectProps, Typography } from "@peersyst/react-components";
...
export interface TokenSelectProps extends Omit<SelectProps<TokenWithBalance, false>, "children" | "options"> {}
