  ...
  return (
    <Modal {...rest} title={translate('accountInfo')} >
      <Col gap={spacing[6]}>
        ...
        <InfoDisplay title={translate('xrpAccount')} content="0Lb00r7sAHTd9CgdQo0HTMTkV8LK4ZnX71" />
        <AlertCallout content={translate('accountInfoCallout')} />
        <Button fullWidth variant="primary">{translate('okGotIt')}</Button>
      </Col>
    </Modal>
  );
}
